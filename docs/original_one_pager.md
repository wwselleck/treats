> This was the original one-pager that I used to summarize my thoughts on the project and the tasks to get it off the ground. It shouldn't get touched anymore, and is just kept around for documentation sake.
...
### Milestone 3
- [x] Twitch Treat Source (MVP - Live streams returned with any scoring system)
- [x] Reddit Treat Source (MVP - Hot posts returned with any scoring system)

### Milestone 4
Tracking progress via Issues now
